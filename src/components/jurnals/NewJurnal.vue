            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="lead_all" v-model="lead_all" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="lead_why" class="form-label">Lead Why</label>
                  <input type="text" class="form-control" id="lead_why" v-model="lead_why" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="lead_what" class="form-label">Lead What</label>
                  <input type="text" class="form-control" id="lead_what" v-model="lead_what" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="lead_when" class="form-label">Lead When</label>
                  <input type="text" class="form-control" id="lead_when" v-model="lead_when" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="lead_where" class="form-label">Lead Where</label>
                  <input type="text" class="form-control" id="lead_where" v-model="lead_where" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="lead_who" class="form-label">Lead Who</label>
                  <input type="text" class="form-control" id="lead_who" v-model="lead_who" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="lead_how" class="form-label">Lead How</label>
                  <input type="text" class="form-control" id="lead_how" v-model="lead_how" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="closing" class="form-label">Closing</label>
                  <input type="text" class="form-control" id="closing" v-model="closing" />
                </div>
              </div>
              <div class="col-md-12">
